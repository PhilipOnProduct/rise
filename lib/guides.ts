...
// DB helpers (awardGuidePoints, incrementTipViews) live in
// lib/guides-server.ts — they run on the service-role admin client and
// must not be pulled into client bundles. This module stays client-safe.
