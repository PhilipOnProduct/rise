/**
 * PHI-118 — Free-form parser eval cases.
 *
 * PHI-34 / RISE-301 — 50 sample inputs covering Elena's input-pattern
 * catalogue. Extracted verbatim from `scripts/eval-freeform-parser.ts`.
 */
