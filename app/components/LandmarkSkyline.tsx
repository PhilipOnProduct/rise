export default function LandmarkSkyline() {
  return (
    <svg
      ...
      role="img"
      aria-label="Illustrated skyline of world landmarks — Colosseum, Eiffel Tower, Big Ben, a mosque, the Taj Mahal, Burj Khalifa, a pagoda, and the Sydney Opera House"
