    ...
    <main className="min-h-screen bg-[#f8f6f1] px-6 flex flex-col items-center justify-center">
      <div className="w-full max-w-lg">
        ...
        <div className="mb-10">
          ...
          <p className="text-[var(--text-secondary)] text-lg">Insider tips from people who actually live there.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <input
            ...
            autoFocus
            className="w-full bg-white border border-[#d4cfc5] focus:border-[#1a6b7f] outline-none rounded-xl px-5 py-5 text-[var(--text-primary)] text-lg placeholder-[#9ca3af] transition-colors"
          />
          <button
            type="submit"
            disabled={!city.trim()}
